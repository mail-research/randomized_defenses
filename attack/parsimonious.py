...
class ParsimoniousAttack(BaseAttack):
    """
    Parsimonious Attack
    """

    def __init__(self, model, log, lp, eps, block_size, block_batch_size, EOT, lb, ub, batch_size, name):
    ...
    def run_one_iter(self, xs_t, labels):
